<template>
  <div class="ma-4 text-center">
    <h1 class="ma-4">Thanks!</h1>
    <p class="ma-4">Bellow, tech used to create this project</p>
    <v-divider></v-divider>
  </div>
  <div></div>
  <div class="ma-4 d-flex adjust-card">
    <AboutCard
  ...
  <div class="text-center">
    ...
    <a
      ...
      href="https://www.linkedin.com/in/arthur-lima-294ab0103/"
      target="_blank"
    >
      <v-btn color="primary"> 👨‍💻  Social medias 🤓 ✌️ </v-btn>
    </a>
  </div>
</template>
...
<script setup>
  ...
  const items = [
    ...
    {
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTe5lcf7bjpXxWMjz9t6SUHSenHvzZtsowTGg&s",
      title: "Vuetify 3",
